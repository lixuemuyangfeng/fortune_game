...
export const gameConfig: GameConfig = {
  evidences: {
    ...
    stock_top_row_highlight: {
      ...
      title: "走势诱饵光斑",
      detail: "热榜旁的小走势图被灯光照得最顺，像是在替第一名补上一个继续上涨的理由。",
      emotion: "envy",
      theme: "stock",
      counterText: "顺眼的曲线不是入口。"
    },
    stock_seven_hundred_card: {
      id: "stock_seven_hundred_card",
      title: "桌边涨幅截图",
      detail: "一张被裁过的涨幅截图混在小票里，只留下红线和百分比，没留下买入时点。",
      emotion: "envy",
      theme: "stock",
    ...
    stock_three_bagger_note: {
      ...
      title: "红箭头笔记本",
      detail: "笔记本把一条红线上扬箭头画得很顺，像是只要照着箭头走，就不用面对中间的回撤。",
      emotion: "fantasy",
      theme: "stock",
    ...
    stock_five_times_sticky: {
      ...
      title: "压账单黄便签",
      detail: "黄色便签夹在笔记和账单之间，把冲动交易贴进日常开销里，越小越像顺手提醒。",
      emotion: "fantasy",
      theme: "stock",
    ...
    stock_limit_up_notice: {
      ...
      title: "风险消息红点",
      detail: "右侧平板弹出财经群消息，风险提示和红点挤在一起，提醒被包装成围观入口。",
      emotion: "envy",
      theme: "stock",
      counterText: "涨停不是邀请函。"
    },
    stock_twenty_cm_card: {
      ...
      title: "计算器旁小票",
      detail: "计算器旁边压着一叠小票，数字看起来都能算清，真正算不清的是追涨后的回撤。",
      emotion: "envy",
      theme: "stock",
    ...
    stock_broker_margin_phone: {
      ...
      title: "桌面的下单屏幕",
      detail: "下单界面亮在手边的手机上，红线、买入按钮和保证金入口挤在同一块屏幕里。危险不在远处的榜单，而在伸手就能按下去。",
      emotion: "stubborn",
      theme: "stock",
    ...
    stock_simulation_full_position: {
      ...
      title: "模拟曲线盒",
      detail: "绿屏小设备上的曲线很顺，像一张安全练习纸，但桌上的账单提醒真实资金不会跟着练习。",
      emotion: "pretend",
      theme: "stock",
    ...
    stock_recommend_group_card: {
      ...
      title: "荐股群入口卡",
      detail: "右侧平板把群消息放在最亮的位置，像是加入以后就能提前知道下一只。",
      emotion: "pretend",
      theme: "stock",
    ...
    stock_dragon_tiger_clip: {
      ...
      title: "财经快讯报纸",
      detail: "报纸快讯被揉在桌角，标题替风险起哄，纸张本身却和普通废纸混在一起。",
      emotion: "envy",
      theme: "stock",
    ...
    stock_sell_house_sheet: {
      ...
      title: "房照钥匙账本",
      detail: "房子照片和钥匙压在桌面中央，旁边全是账本和票据，生活底线已经被拖进交易桌。",
      emotion: "breakdown",
      theme: "stock",
    ...
    stock_risk_disclosure_corner: {
      ...
      title: "风险揭示折角",
      detail: "风险揭示书露在右下角，被账单和杂物挤住，真正该先看的那一页最不起眼。",
      emotion: "stubborn",
      theme: "stock",
    ...
    stock_heat_push_phone: {
      ...
      title: "热榜催促红点",
      detail: "主显示器右上角的红点把热榜变成待处理事项，负责制造催促，不负责盈亏。",
      emotion: "envy",
      theme: "stock",
  ...
  scenes: [
    ...
    },
    {
      ...
      hotspots: [
        { id: "h1", evidenceId: "polished_ai_demo_rows", x: 78.0, y: 18.8, hitX: 78.0, hitY: 18.8, hitWidth: 10.0, hitHeight: 11.0, radius: 7, label: "只跑样例的满分屏", found: false, renderMode: "embedded", revealText: "满分样例不等于真实上线", animationKind: "kline" },
    ...
    },
    {
      ...
      decoys: [
        ...
        { id: "slide-action-list", x: 70.4, y: 22.0, hitWidth: 9.2, hitHeight: 14.0, label: "普通行动列表" },
      ...
      hotspots: [
        ...
        { id: "h6", evidenceId: "rejected_headcount_form", x: 86.1, y: 50.2, hitX: 86.1, hitY: 50.2, hitWidth: 9.5, hitHeight: 15.0, radius: 7, label: "人头申请不通过", found: false, renderMode: "embedded", revealText: "人没补，目标先补上去了", animationKind: "receipt" },
        { id: "h7", evidenceId: "friday_deadline_calendar", x: 12.5, y: 77.2, hitX: 12.5, hitY: 77.2, hitWidth: 10.0, hitHeight: 11.0, radius: 7, label: "周五截止日历", found: false, renderMode: "embedded", revealText: "截止日不是资源", animationKind: "note" },
        { id: "h8", evidenceId: "opportunity_laser_pointer", x: 76.4, y: 19.2, hitX: 76.4, hitY: 19.2, hitWidth: 4.2, hitHeight: 5.8, radius: 7, label: "机会激光笔红点", found: false, renderMode: "embedded", revealText: "被照亮的是话术", animationKind: "alert" },
        { id: "h9", evidenceId: "budget_locked_folder", x: 71.9, y: 81.4, hitX: 71.9, hitY: 81.4, hitWidth: 11.0, hitHeight: 11.0, radius: 7, label: "预算锁盒", found: false, renderMode: "embedded", revealText: "预算锁住以后，机会只剩口头", animationKind: "contract" },
        { id: "h10", evidenceId: "erased_whiteboard_risk", x: 43.8, y: 23.6, hitX: 43.8, hitY: 23.6, hitWidth: 9.0, hitHeight: 12.0, radius: 7, label: "白板淡掉的风险", found: false, renderMode: "embedded", revealText: "擦掉字，不等于擦掉责任", animationKind: "sign" }
      ]
    },
    {
      id: "nest",
      ...
      decoys: [
        ...
        { id: "lamp-head", x: 9.2, y: 53.2, hitWidth: 8.0, hitHeight: 8.0, label: "台灯" },
        { id: "ordinary-left-tags", x: 8.0, y: 58.0, hitWidth: 12.0, hitHeight: 14.0, label: "普通旧票据" },
        { id: "burned-paper-decoy", x: 24.0, y: 68.0, hitWidth: 8.0, hitHeight: 11.0, label: "烧焦纸片" },
        ...
        { id: "ordinary-token-row", x: 35.0, y: 91.0, hitWidth: 11.0, hitHeight: 7.0, label: "普通圆牌" },
        ...
        { id: "ordinary-photo-left", x: 64.5, y: 72.0, hitWidth: 6.0, hitHeight: 10.0, label: "普通照片" },
      ...
      hotspots: [
        { id: "h1", evidenceId: "nest_office_noise_core", x: 56.8, y: 48.7, hitX: 56.8, hitY: 48.7, hitWidth: 7.5, hitHeight: 12.0, radius: 7, label: "碎键盘行情芯", found: false, renderMode: "embedded", revealText: "踏空噪声靠半张行情纸续命", animationKind: "kline" },
        { id: "h2", evidenceId: "nest_gold_receipt_heat", x: 12.0, y: 67.9, hitX: 12.0, hitY: 67.9, hitWidth: 14.0, hitHeight: 15.0, radius: 7, label: "半焦金店小票", found: false, renderMode: "embedded", revealText: "接盘余热还在小票边上冒烟", animationKind: "receipt" },
        { id: "h3", evidenceId: "nest_lottery_near_miss_roll", x: 31.6, y: 71.4, hitX: 31.6, hitY: 71.4, hitWidth: 10.0, hitHeight: 14.0, radius: 7, label: "连环差一点票卷", found: false, renderMode: "embedded", revealText: "差一点卷起来也不是下一张", animationKind: "ticket" },
        { id: "h4", evidenceId: "nest_social_filter_shard", x: 49.2, y: 72.9, hitX: 49.2, hitY: 72.9, hitWidth: 7.0, hitHeight: 14.0, radius: 7, label: "高光滤镜碎片", found: false, renderMode: "embedded", revealText: "镜片只留下可发布版本", animationKind: "photo" },
        { id: "h5", evidenceId: "nest_ai_panic_meter", x: 17.6, y: 31.9, hitX: 17.6, hitY: 31.9, hitWidth: 10.0, hitHeight: 10.0, radius: 7, label: "恐慌课程计时器", found: false, renderMode: "embedded", revealText: "倒计时先替卖课的人工作", animationKind: "alert" },
        { id: "h6", evidenceId: "nest_meeting_blame_pipe", x: 78.1, y: 46.7, hitX: 78.1, hitY: 46.7, hitWidth: 13.0, hitHeight: 12.0, radius: 7, label: "甩锅管阀", found: false, renderMode: "embedded", revealText: "文件沿着管子掉进同一个锅里", animationKind: "contract" },
        { id: "h7", evidenceId: "tag_not_every_car", x: 87.1, y: 84.3, hitX: 87.1, hitY: 84.3, hitWidth: 13.0, hitHeight: 14.0, radius: 7, label: "不上车金属牌", found: false, renderMode: "embedded", revealText: "车多，不代表都值得上", animationKind: "sign" },
        { id: "h8", evidenceId: "tag_stubborn_not_strategy", x: 27.0, y: 85.7, hitX: 27.0, hitY: 85.7, hitWidth: 11.0, hitHeight: 12.0, radius: 7, label: "裂盾策略牌", found: false, renderMode: "embedded", revealText: "盾裂了，嘴硬就挡不住了", animationKind: "goldLine" },
        { id: "h9", evidenceId: "tag_near_miss_not_next", x: 40.6, y: 82.5, hitX: 40.6, hitY: 82.5, hitWidth: 8.0, hitHeight: 9.0, radius: 7, label: "止损停牌", found: false, renderMode: "embedded", revealText: "停止牌压住差一点出口", animationKind: "scratch" },
        { id: "h10", evidenceId: "tag_publishable_version", x: 58.7, y: 72.5, hitX: 58.7, hitY: 72.5, hitWidth: 7.0, hitHeight: 14.0, radius: 7, label: "可发布画框", found: false, renderMode: "embedded", revealText: "画框只夹住最好看的角", animationKind: "photo" },
        { id: "h11", evidenceId: "tag_panic_sellers_profit", x: 12.6, y: 44.0, hitX: 12.6, hitY: 44.0, hitWidth: 4.5, hitHeight: 8.0, radius: 7, label: "恐慌价签", found: false, renderMode: "embedded", revealText: "吓人的人先把价签挂好了", animationKind: "note" },
        { id: "h12", evidenceId: "tag_no_resource_blame", x: 90.6, y: 36.5, hitX: 90.6, hitY: 36.5, hitWidth: 7.5, hitHeight: 12.0, radius: 7, label: "流程封签", found: false, renderMode: "embedded", revealText: "锁阀先把锅挡回流程", animationKind: "contract" }
      ]
    },
    {
      id: "stock",
      ...
      decoys: [
        { id: "window-sill", x: 5.0, y: 32.0, hitWidth: 8.0, hitHeight: 8.0, label: "窗台边" },
        { id: "family-photo", x: 54.0, y: 12.8, hitWidth: 7.0, hitHeight: 10.0, label: "家庭相框" },
        { id: "plant-pot", x: 45.0, y: 21.0, hitWidth: 8.0, hitHeight: 10.0, label: "盆栽" },
        { id: "drawer-labels", x: 47.8, y: 33.0, hitWidth: 8.0, hitHeight: 14.0, label: "抽屉标签" },
        { id: "back-calendar", x: 80.5, y: 7.0, hitWidth: 15.0, hitHeight: 10.0, label: "墙上日历" },
        { id: "desk-lamp", x: 92.0, y: 21.0, hitWidth: 10.0, hitHeight: 16.0, label: "台灯" },
        { id: "pen-cup", x: 89.4, y: 39.5, hitWidth: 8.0, hitHeight: 7.0, label: "笔筒" },
        { id: "ordinary-monitor-row", x: 57.0, y: 26.5, hitWidth: 11.0, hitHeight: 7.0, label: "普通榜单行" },
        { id: "monitor-summary-table", x: 70.5, y: 39.5, hitWidth: 10.0, hitHeight: 10.0, label: "普通成交表" },
        { id: "monitor-small-chart", x: 77.5, y: 44.5, hitWidth: 9.0, hitHeight: 5.0, label: "普通小图" },
        { id: "center-paper-ball", x: 57.0, y: 49.0, hitWidth: 8.0, hitHeight: 8.0, label: "中间纸团" },
        { id: "right-paper-ball", x: 66.0, y: 45.0, hitWidth: 7.0, hitHeight: 6.0, label: "右侧纸团" },
        { id: "coffee-mug", x: 65.0, y: 57.0, hitWidth: 8.0, hitHeight: 12.0, label: "咖啡杯" },
        { id: "yellow-warning-note", x: 67.2, y: 59.5, hitWidth: 5.0, hitHeight: 5.0, label: "黄色便签" },
        { id: "snack-bag", x: 94.0, y: 67.0, hitWidth: 10.0, hitHeight: 11.0, label: "零食袋" },
        { id: "tissue-box", x: 97.0, y: 78.0, hitWidth: 7.0, hitHeight: 13.0, label: "纸巾袋" },
        { id: "loose-coins", x: 21.0, y: 96.0, hitWidth: 8.0, hitHeight: 6.0, label: "零钱" },
        { id: "blue-sticky-stack", x: 36.0, y: 91.0, hitWidth: 8.0, hitHeight: 8.0, label: "彩色便签" },
        { id: "black-pen", x: 42.5, y: 88.0, hitWidth: 8.0, hitHeight: 5.0, label: "黑笔" },
        { id: "red-pen", x: 48.5, y: 86.0, hitWidth: 9.0, hitHeight: 5.0, label: "红笔" },
        { id: "ordinary-notebook-text", x: 42.5, y: 59.5, hitWidth: 7.0, hitHeight: 8.0, label: "普通笔记" },
        { id: "ordinary-receipt-center", x: 38.0, y: 74.0, hitWidth: 8.0, hitHeight: 7.0, label: "普通小票" },
        { id: "plain-news-strip", x: 50.0, y: 73.0, hitWidth: 8.0, hitHeight: 6.0, label: "普通新闻条" },
        { id: "house-photo-second", x: 59.0, y: 90.0, hitWidth: 9.0, hitHeight: 9.0, label: "另一张房照" },
        { id: "cable-coil", x: 78.0, y: 94.0, hitWidth: 9.0, hitHeight: 9.0, label: "线缆圈" },
        { id: "right-phone-frame", x: 94.0, y: 51.0, hitWidth: 4.0, hitHeight: 6.0, label: "消息屏边框" }
      ],
      hotspots: [
        { id: "h1", evidenceId: "stock_top_row_highlight", x: 70.3, y: 29.9, hitX: 70.3, hitY: 29.9, hitWidth: 12.0, hitHeight: 12.0, radius: 7, label: "走势诱饵光斑", found: false, renderMode: "embedded", revealText: "顺眼的曲线也只说明已经画完", animationKind: "kline" },
        { id: "h2", evidenceId: "stock_seven_hundred_card", x: 26.7, y: 76.5, hitX: 26.7, hitY: 76.5, hitWidth: 13.0, hitHeight: 15.0, radius: 7, label: "桌边涨幅截图", found: false, renderMode: "embedded", revealText: "截图只留下涨过的那段", animationKind: "kline" },
        { id: "h3", evidenceId: "stock_three_bagger_note", x: 49.0, y: 56.8, hitX: 49.0, hitY: 56.8, hitWidth: 9.0, hitHeight: 7.0, radius: 7, label: "红箭头笔记本", found: false, renderMode: "embedded", revealText: "箭头负责上扬，风险没画进去", animationKind: "note" },
        { id: "h4", evidenceId: "stock_five_times_sticky", x: 49.0, y: 62.8, hitX: 49.0, hitY: 62.8, hitWidth: 8.0, hitHeight: 6.0, radius: 7, label: "压账单黄便签", found: false, renderMode: "embedded", revealText: "小便签把冲动夹进账单", animationKind: "note" },
        { id: "h5", evidenceId: "stock_limit_up_notice", x: 88.4, y: 45.5, hitX: 88.4, hitY: 45.5, hitWidth: 10.0, hitHeight: 5.0, radius: 7, label: "风险消息红点", found: false, renderMode: "embedded", revealText: "群消息把风险说成机会", animationKind: "alert" },
        { id: "h6", evidenceId: "stock_twenty_cm_card", x: 14.0, y: 76.0, hitX: 14.0, hitY: 76.0, hitWidth: 12.0, hitHeight: 10.0, radius: 7, label: "计算器旁小票", found: false, renderMode: "embedded", revealText: "算得清小票，算不清回撤", animationKind: "receipt" },
        { id: "h7", evidenceId: "stock_broker_margin_phone", x: 33.8, y: 74.9, hitX: 33.8, hitY: 74.9, hitWidth: 7.0, hitHeight: 16.0, radius: 7, label: "桌面的下单屏幕", found: false, renderMode: "embedded", revealText: "红线和买入键已经在手边", animationKind: "phone" },
        { id: "h8", evidenceId: "stock_simulation_full_position", x: 71.5, y: 52.5, hitX: 71.5, hitY: 52.5, hitWidth: 12.0, hitHeight: 10.0, radius: 7, label: "模拟曲线盒", found: false, renderMode: "embedded", revealText: "模拟曲线不替你还钱", animationKind: "kline" },
        { id: "h9", evidenceId: "stock_recommend_group_card", x: 88.8, y: 51.8, hitX: 88.8, hitY: 51.8, hitWidth: 10.0, hitHeight: 5.0, radius: 7, label: "荐股群入口卡", found: false, renderMode: "embedded", revealText: "进群不等于研究", animationKind: "chat" },
        { id: "h10", evidenceId: "stock_dragon_tiger_clip", x: 58.2, y: 66.6, hitX: 58.2, hitY: 66.6, hitWidth: 10.0, hitHeight: 7.0, radius: 7, label: "财经快讯报纸", found: false, renderMode: "embedded", revealText: "快讯只负责催促", animationKind: "news" },
        { id: "h11", evidenceId: "stock_sell_house_sheet", x: 56.5, y: 81.8, hitX: 56.5, hitY: 81.8, hitWidth: 10.0, hitHeight: 14.0, radius: 7, label: "房照钥匙账本", found: false, renderMode: "embedded", revealText: "生活底线被拖上桌", animationKind: "contract" },
        { id: "h12", evidenceId: "stock_risk_disclosure_corner", x: 80.8, y: 79.3, hitX: 80.8, hitY: 79.3, hitWidth: 12.0, hitHeight: 10.0, radius: 7, label: "风险揭示折角", found: false, renderMode: "embedded", revealText: "该先看的被压在角落", animationKind: "paper" },
        { id: "h13", evidenceId: "stock_heat_push_phone", x: 80.0, y: 16.9, hitX: 80.0, hitY: 16.9, hitWidth: 3.8, hitHeight: 3.8, radius: 7, label: "热榜催促红点", found: false, renderMode: "embedded", revealText: "红点负责热，不负责盈亏", animationKind: "phone" }
      ]
    }
  ]
};
