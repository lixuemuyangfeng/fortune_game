...
export const gameConfig: GameConfig = {
  ...
  scenes: [
    ...
    },
    {
      ...
      hotspots: [
        { id: "h1", evidenceId: "gold_receipt", x: 26.4, y: 72.2, hitX: 26.4, hitY: 72.2, hitWidth: 8.5, hitHeight: 8.5, radius: 7, label: "金店小票", found: false, image: "/assets/game/rooftop/clues/folded-receipt.png", imageWidth: 4.4, anchorX: 50, anchorY: 50, hitScale: 1, revealText: "小票垫不住追高的手", animationKind: "receipt" },
        { id: "h2", evidenceId: "hedge_group", x: 44.2, y: 68.6, hitX: 44.2, hitY: 68.6, hitWidth: 7.4, hitHeight: 10, radius: 8, label: "稳健避险交流群", found: false, image: "/assets/game/rooftop/clues/group-chat.png", imageWidth: 3.5, anchorX: 50, anchorY: 50, hitScale: 1, revealText: "每三分钟问一次，还叫长期", animationKind: "chat" },
        { id: "h3", evidenceId: "risk_headline", x: 71.4, y: 71.5, hitX: 71.4, hitY: 71.5, hitWidth: 7.2, hitHeight: 7.4, radius: 8, label: "避险快讯截图", found: false, image: "/assets/game/rooftop/clues/risk-news.png", imageWidth: 4.1, anchorX: 50, anchorY: 50, hitScale: 1, revealText: "没有来源的标题，最会替你下单", animationKind: "news" },
        { id: "h4", evidenceId: "price_alarm", x: 58.4, y: 69.6, hitX: 58.4, hitY: 69.6, hitWidth: 5.6, hitHeight: 10.6, radius: 7, label: "跌幅提醒手机", found: false, image: "/assets/game/rooftop/clues/price-alert.png", imageWidth: 2.7, anchorX: 50, anchorY: 50, hitScale: 1, revealText: "长期资产正在被五分钟一刷审问", animationKind: "alert" },
        { id: "h5", evidenceId: "rooftop_warning", x: 31.2, y: 39.2, hitX: 31.2, hitY: 39.2, hitWidth: 7.4, hitHeight: 7.2, radius: 8, label: "敏感行情告示", found: false, image: "/assets/game/rooftop/clues/warning-sign.png", imageWidth: 4.9, anchorX: 50, anchorY: 50, hitScale: 1, revealText: "天台门口已经替你写了风险提示", animationKind: "sign" },
        { id: "h6", evidenceId: "leverage_contract", x: 17.6, y: 58.6, hitX: 17.6, hitY: 58.6, hitWidth: 7.2, hitHeight: 8.4, radius: 7, label: "杠杆合同边角", found: false, image: "/assets/game/rooftop/clues/leverage-paper.png", imageWidth: 3.8, anchorX: 50, anchorY: 50, hitScale: 1, revealText: "借来的底气已经躲到管道边", animationKind: "contract" }
      ]
    },
    {
      id: "moments",
